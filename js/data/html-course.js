...
const HTML_COURSE = {
  ...
  lessons: [
    ...
    },
    {
      ...
      type: "challenge",
      content: [{"type":"text","text":"\n# 🎯 تحدي: رتّب الوسوم!\n\n![مساحة عمل مبرمج](https://storage.googleapis.com/mindsmith/uploads/32147183-921a-44cd-9093-fe72727d5b70/generated-image.webp)\n\nهل تذكر ما تعلمته؟ حان وقت الاختبار الممتع!\n"}],
    ...
    },
    {
      ...
      type: "challenge",
      content: [{"type":"text","text":"\n# 🎮 تحدي: أكمل الكود!\n\n![خلايا إنترنت مرتبطة](https://storage.googleapis.com/mindsmith/uploads/bff54f10-e796-4040-b41b-812310d82bb4/generated-image.webp)\n\nهل تتذكر ما تعلمته؟ جهّز نفسك!\n"}],
    ...
    },
    {
      ...
      type: "challenge",
      content: [{"type":"text","text":"\n# 🎨 تحدي CSS: جمّل هذه الصفحة!\n\n![لوحة ألوان ممتعة](https://storage.googleapis.com/mindsmith/uploads/74bc709b-b811-4a60-bff6-e7fcd3636c82/generated-image.webp)\n\nأظهر مهاراتك في التنسيق!\n"}],
    ...
    },
    {
      ...
      type: "intro",
      content: [{"type":"text","text":"\n# 🌟 تهانينا! أنت الآن مبرمج HTML!\n\n![احتفال بالتخرج](https://storage.googleapis.com/mindsmith/uploads/f081a1bb-b694-4d46-a014-09ff0d33ee08/generated-image.webp)\n\nأتممت الدورة بنجاح وأصبحت تعرف بناء صفحات الإنترنت!\n"},{"type":"text","text":"\n## مراجعة سريعة — اقلب البطاقات!\n"},{"type":"flashcards","cards":[{"front":"HTML","back":"لغة بناء هيكل صفحات الإنترنت (HyperText Markup Language)"},{"front":"<head>","back":"يحتوي على معلومات الصفحة مثل العنوان المخفي وإعدادات الملف"},{"front":"<body>","back":"يحتوي على كل المحتوى المرئي الذي يظهر للزائر كالصور والنصوص"},{"front":"<img>","back":"وسم لإضافة صورة، ويحتاج لخاصية src لتحديد مصدرها"},{"front":"<a>","back":"وسم لإضافة رابط، ويحتاج لخاصية href لتحديد وجهته"},{"front":"CSS","back":"لغة تنسيق وظيفتها تجميل صفحات الويب من حيث الألوان والمسافات"}]},{"type":"text","text":"\n## الخطوات التالية في رحلتك البرمجية\n"},{"type":"list","items":["HTML — أتقنته! ابنِ المزيد من الصفحات","CSS المتقدم — تعلّم Flexbox وGrid للتصميم الاحترافي","JavaScript — أضف الحركة والتفاعل لموقعك","مشاريع حقيقية — ابنِ موقعاً كاملاً لتعرضه للعالم!"],"mode":"Staircase"},{"type":"text","text":"\n## رسالة لك يا مبرمج الغد\nكل موقع رائع تراه على الإنترنت بدأ بشخص تعلّم HTML تماماً مثلك.\nاستمر في الممارسة، استمر في البناء، واستمر في التعلم.\nالعالم الرقمي ينتظر إبداعك!\n"}],
      questions: [],
      codeExamples: [],
      activities: []
    },
...
// CSS_COURSE and JS_COURSE are loaded from js/data/css-js-courses.js
